...
echo "SeqPrep -f $1.R1.fastq.gz -r $1.R2.fastq.gz -1 $1.SP.R1.fastq.gz -2 $1.SP.R2.fastq.gz -A CTGTCTCTTATACACATCTC -B CTGTCTCTTATACACATCTG"
SeqPrep -f $1.R1.fastq.gz -r $1.R2.fastq.gz -1 $1.SP.R1.fastq.gz -2 $1.SP.R2.fastq.gz -A CTGTCTCTTATACACATCTC -B CTGTCTCTTATACACATCTG
echo "Running Sickle..."
